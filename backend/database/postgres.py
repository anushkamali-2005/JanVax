...
async def create_tables():
    ...
    async with _engine.begin() as conn:
        await conn.execute(text("""
            ...
            CREATE INDEX IF NOT EXISTS idx_predictions_child
                ON ai_predictions(child_id);

            CREATE INDEX IF NOT EXISTS idx_predictions_hash
                ON ai_predictions(record_hash);
            ...
            CREATE INDEX IF NOT EXISTS idx_decisions_child
                ON agent_decisions(child_id);
            ...
            CREATE INDEX IF NOT EXISTS idx_memory_family
                ON agent_memory(family_uid);
            ...
            CREATE INDEX IF NOT EXISTS idx_scheduler_child
                ON scheduler_sessions(child_id);

            CREATE INDEX IF NOT EXISTS idx_scheduler_phone
                ON scheduler_sessions(parent_phone);
        """))
