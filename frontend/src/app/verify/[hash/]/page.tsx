...
import { Shield, CheckCircle, XCircle, ExternalLink, Clock, Tag, ArrowLeft } from "lucide-react";
                                ...
                                <div className="card" style={{ borderColor: hashResult.is_valid ? "var(--green-muted)" : "var(--risk-high)" }}>
                                    <div style={{ display: "flex", gap: "1rem", alignItems: "center", marginBottom: "1.5rem" }}>
                                        ...
                                        <div>
                                            ...
                                            <p style={{ fontSize: "0.8125rem", color: "var(--ink-4)" }}>Verified on {new Date(hashResult.stored_at).toLocaleDateString()}</p>
                                        </div>
                                    </div>
